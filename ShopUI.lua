...
function Library.Create(name,parent)
    local shopUI = {}
    ...
    shopFrame.Size = UDim2.new(0, 1000, 0, 650)
    shopFrame.Position = UDim2.new(0.5, -500, 0.5, -325)
    ...
    shopTitle.Text = "เลือกความสําคัญของรางวัล (อันไหนเลือกก่อนมันจะ join ด่านนั้นก่อน)"
